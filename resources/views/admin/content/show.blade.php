...
@section('headerTitle', 'Content #' . $model->id)
@section('pageTitle', 'Content #' . $model->id)
            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <div class="pull-left mrg-btm-20">
                        <a href="{{ route('user-relation.show', ['id'=>$model->user_relation_id]) }}" class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                    </div>
