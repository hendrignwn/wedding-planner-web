...
@section('headerTitle', 'Content Lists ' . $model->name)
@section('pageTitle', 'Content Lists ' . $model->name)
        ...
        <div class="card">
            <div class="card-block">
                <div class="pull-left mrg-btm-20">
                    <a href="{{ route('user-relation.show', ['id'=>$userRelationId]) }}" class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                </div>
...
<script>
    ...
    processing: true,
            ...
            ajax: {
            url: '{!! route('content.data', ['id' => $id, 'userRelationId' => $userRelationId]) !!}',
                    data: function (d) {
