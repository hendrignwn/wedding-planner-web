...
@section('headerTitle', 'Content Detail #' . $model->id)
@section('pageTitle', 'Content Detail #' . $model->id)
            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <div class="pull-left mrg-btm-20">
                        <a href="{{ route('content.show', ['id'=>$model->content_id]) }}" class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                    </div>
...
oTable = $('#detail-table').DataTable({
    ...
    ajax: {
    url: '{!! route('content-detail-list.data', ['id' => $model->id]) !!}',
        data: function (d) {
